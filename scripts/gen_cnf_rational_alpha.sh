...
python src/data_maker.py remove_int_alpha_cnf $DIR $SEED  # same here for SEED

# print datasets info in a file
python src/data_loader.py $DIR/dataset.pkl > $DIR/dataset_info.txt
python src/data_loader.py $DIR/dataset_float_alpha.pkl > $DIR/dataset_float_alpha_info.txt