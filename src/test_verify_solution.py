...
if __name__ == '__main__':
    ...
    print(f"The assignment is a model of the satisfiable formula: {verify_solution(n, formula_sat, assignment)}")
    print(f"The assignment is a model of the satisfiable formula: {verify_solution(n, formula_unsat, assignment)}")