...
def main():
    ...
    parser.add_argument('log_file', type=str, help="Log file from LLM exexcution")
    ...
    with open(f'{log_directory}/data_log_mc.log', 'w', encoding='utf-8') as f:
        for id, line in enumerate(file_lines):
            ...
            sample_dict['model_count'] = model_counting(sample_dict['formula'], sample_dict['num_vars'])
